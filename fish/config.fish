...
# Space emacs aliases:
alias ses='emacs --with-profile space-emacs --daemon'

# Nordvpn aliases:
alias vpn='sudo surfshark-vpn'
alias disconnect='sudo surfshark-vpn down'

# Devour windows:
alias bored='devour dolphin /mnt/sda3/Personal_Development/'
