...
keys = [
         ...
         Key([mod], "F2",
             ...
             desc= "firefox developer edition"
             ),
        # Switch on the secondary display:
         Key([mod], "F3",
         ...
         Key([mod], "F1",
             lazy.spawn(incognito),
             desc='chrome-incognito'
             ),
         Key([mod, "shift"] ,"z",
             lazy.spawn("yakuake"),
             desc='yakuake terminal'
             ),
         Key([mod], "a",
             lazy.spawn("nemo"),
             desc="File Manager"
         ...
         Key(["control", "shift"], "e",
             lazy.spawn("emacsclient -c -s doom -a 'emacs'"),
             desc='doom emacs'
             ),
        Key(["control", "shift"], "s",
            lazy.spawn("emacsclient -c -s space-emacs -a 'emacs'"),
            desc='Space Emacs'
            ),
         ### Volume Control:
...
def init_screens():
    return [Screen(top=bar.Bar(widgets=init_widgets_screen1(), opacity=0.80, size=20)),
            Screen(top=bar.Bar(widgets=init_widgets_screen2(), opacity=0.80, size=20)),
            Screen(top=bar.Bar(widgets=init_widgets_screen1(), opacity=0.80, size=20))]
