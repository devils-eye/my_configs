...
-- Xmobar
import XMonad.Hooks.DynamicLog (dynamicLogWithPP, xmobarPP, ppOutput, ppCurrent, ppHidden, ppHiddenNoWindows, ppTitle, ppLayout, ppUrgent)
...
myKeys conf@(XConfig {XMonad.modMask = modm}) = M.fromList $
    ...
    -- , ((modm, xK_F3), xF86XK_AudioRaiseVolume), spawn "pactl set-sink-volume 0 +5%")
    , ((modm, xK_F3), spawn "amixer -D pulse sset Master 3%+")
    -- , ((modm, xK_F3), spawn "mpc volume +5")
    -- , ((modm, xK_F2), xF86XK_AudioLowerVolume), spawn "pactl set-sink-volume 0 -5%")
    , ((modm, xK_F2), spawn "amixer -D pulse sset Master 3%-")
    -- , ((modm, xK_F2), spawn "mpc volume -5")
    -- , ((modm, xK_F4), xF86XK_AudioMute), spawn "pactl set-sink-mute 0 toggle")
    , ((modm, xK_F4), spawn "pactl set-sink-mute 0 toggle")

    -- My custom keybindings
    , ((modm,  xK_a), spawn "dolphin")
    , ((modm,  xK_o), spawn "opera")
    , ((modm,  xK_b), spawn "google-chrome-stable")
    , ((modm,  xK_F5), spawn "google-chrome-stable --incognito")
    , ((modm,  xK_y), spawn "yakuake")
    , ((modm,  xK_z), spawn "kitty")
    ...
    -- My Stuff
    , ((modm .|. mod1Mask,  xK_b     ), spawn "exec ~/bin/bartoggle")
